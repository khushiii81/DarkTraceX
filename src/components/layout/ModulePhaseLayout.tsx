      ...
      <div className="max-w-6xl mx-auto w-full flex-1 flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-8">
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 w-full sm:w-auto rounded-xl border border-white/10 text-sm font-bold text-white hover:bg-white/5 disabled:opacity-20 disabled:hover:bg-transparent transition-all"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 w-full sm:w-auto rounded-xl bg-red-600 hover:bg-red-500 border border-red-500 text-sm font-bold text-white shadow-[0_0_20px_rgba(220,38,38,0.3)] disabled:opacity-20 disabled:hover:bg-red-600 disabled:shadow-none transition-all"
          >
            Next
